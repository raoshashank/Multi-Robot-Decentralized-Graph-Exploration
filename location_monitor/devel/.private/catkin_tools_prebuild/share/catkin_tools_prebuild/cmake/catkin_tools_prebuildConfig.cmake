...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/shashank/catkin_ws/src/location_monitor/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/shashank/catkin_ws/src/location_monitor/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/shashank/catkin_ws/src/location_monitor/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shashank/catkin_ws/src/location_monitor/build/catkin_tools_prebuild/${idir}'.  Ask the maintainer 'jbohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shashank/catkin_ws/src/location_monitor/devel/.private/catkin_tools_prebuild/lib;/home/shashank/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${catkin_tools_prebuild_dep}_FOUND)
      find_package(${catkin_tools_prebuild_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${catkin_tools_prebuild_dep} REQUIRED ${depend_list})
  endif()
